...
{{<figure align="center" src="https://raw.githubusercontent.com/aritang/aritangPictures/main/static/data_vis/SHERLOCK.jpeg" caption="i kinda liked it">}}
...
{{<figure align="center" src="https://raw.githubusercontent.com/aritang/aritangPictures/main/static/data_vis/code_compare.png" caption="The code is generated by copy-and-paste prompting a GPT model, with the output being copied and pasted to submit as some homework solution. This scenario corresponds to a realistic problem faced by educators in introductory programming courses - when instructors assigned homeworks but students just copy and paste GPT's answer. ">}}
...
- Btw, ***perturbation*** means, randomly masking some words (tokens) and then use another GPT model to fill in the blanks. Like this:
    ...
    {{<figure align="center" src="https://raw.githubusercontent.com/aritang/aritangPictures/main/static/data_vis/perturb_explain.jpeg" caption="how perturbation works.">}}
...
{{<figure align="center" src="https://raw.githubusercontent.com/aritang/aritangPictures/main/static/data_vis/log_likelihood_rule.jpeg" caption="Given any piece of code string, we can obtain its log-likelihood (loss function value) w.r.t. a language model. For an original input code string x and its perturbation, the log(p) distribution varies statistically when according to its label (human/AI).">}}
...
{{<figure align="center" src="https://raw.githubusercontent.com/aritang/aritangPictures/main/static/data_vis/result.jpeg" caption="results obtained on the test set. it's actually pretty neat for this small test out. we also tested Mitchell's original threshold-based classification method (blue line on the left). it turns out that a little bit machine learning boost a long way.">}}
